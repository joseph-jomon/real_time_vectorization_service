...
class ImageVectorizer:
    def __init__(self, model_name: str = "geolocal/StreetCLIP"): # models are loaded in the __init__ of the class. that means This will load the model as soon as the instance is created
